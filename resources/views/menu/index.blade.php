    ...
    <div class="container-fluid">
       <h3 class="fw-bold">Toko {{ $toko->name }}</h3>
        ...
        <div class="menu-grid">
            ...
            <a href="{{route('kasir.index',$toko->id_toko)}}" class="text-decoration-none">
                <div class="card h-100 text-center shadow-sm border-0 py-4">
                    <div class="card-body">
                        <div class="mb-3 text-primary">
            ...
            <a href="{{route('customer.index',$toko->id_toko)}}" class="text-decoration-none">
                <div class="card h-100 text-center shadow-sm border-0 py-4">
                    <div class="card-body">
                        <div class="mb-3 text-primary">
            ...
            <a href="{{route('produk.index', $toko->id_toko)}}" class="text-decoration-none">
                <div class="card h-100 text-center shadow-sm border-0 py-4">
                    <div class="card-body">
                        <div class="mb-3 text-primary">
            ...
            <a href="{{route('supplier.index',$toko->id_toko)}}" class="text-decoration-none">
                <div class="card h-100 text-center shadow-sm border-0 py-4">
                    <div class="card-body">
                        <div class="mb-3 text-primary">
